...
pkgdatadir = $(datadir)/luaposix
pkgincludedir = $(includedir)/luaposix
pkglibdir = $(libdir)/luaposix
pkglibexecdir = $(libexecdir)/luaposix
...
DIST_COMMON = README $(am__configure_deps) $(dist_data_DATA) \
	...
	$(srcdir)/config.h.in $(srcdir)/luaposix.rockspec.in \
	$(srcdir)/luarocks-config.lua.in $(top_srcdir)/configure \
...
CONFIG_CLEAN_FILES = luaposix.rockspec luarocks-config.lua
...
am__installdirs = "$(DESTDIR)$(libdir)" "$(DESTDIR)$(datadir)" \
	"$(DESTDIR)$(docdir)" "$(DESTDIR)$(examplesdir)"
LTLIBRARIES = $(lib_LTLIBRARIES)
curses_c_la_LIBADD =
am_curses_c_la_OBJECTS = lcurses.lo
curses_c_la_OBJECTS = $(am_curses_c_la_OBJECTS)
AM_V_lt = $(am__v_lt_$(V))
am__v_lt_ = $(am__v_lt_$(AM_DEFAULT_VERBOSITY))
am__v_lt_0 = --silent
curses_c_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CCLD) $(AM_CFLAGS) $(CFLAGS) \
	$(curses_c_la_LDFLAGS) $(LDFLAGS) -o $@
posix_c_la_LIBADD =
am_posix_c_la_OBJECTS = posix_c_la-lposix.lo
posix_c_la_OBJECTS = $(am_posix_c_la_OBJECTS)
posix_c_la_LINK = $(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) \
	$(LIBTOOLFLAGS) --mode=link $(CCLD) $(posix_c_la_CFLAGS) \
	$(CFLAGS) $(posix_c_la_LDFLAGS) $(LDFLAGS) -o $@
DEFAULT_INCLUDES = -I.
...
SOURCES = $(curses_c_la_SOURCES) $(posix_c_la_SOURCES)
DIST_SOURCES = $(curses_c_la_SOURCES) $(posix_c_la_SOURCES)
am__can_run_installinfo = \
  case $$AM_UPDATE_INFO_DIR in \
    n|no|NO) false;; \
    *) (install-info --version) >/dev/null 2>&1;; \
  esac
DATA = $(dist_data_DATA) $(dist_doc_DATA) $(examples_DATA)
ETAGS = etags
CTAGS = ctags
...
ACLOCAL = ${SHELL} /home/rrt/repo/luaposix/build-aux/missing --run aclocal-1.11
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
ARFLAGS = cru
AUTOCONF = ${SHELL} /home/rrt/repo/luaposix/build-aux/missing --run autoconf
AUTOHEADER = ${SHELL} /home/rrt/repo/luaposix/build-aux/missing --run autoheader
AUTOMAKE = ${SHELL} /home/rrt/repo/luaposix/build-aux/missing --run automake-1.11
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
LUA = /home/rrt/local/bin/x86_64-linux-gnu/lua
LUA_EXEC_PREFIX = ${exec_prefix}
LUA_INCLUDE = -I/home/rrt/local/include/lua5.2
LUA_PLATFORM = unknown
LUA_PREFIX = ${prefix}
LUA_SHORT_VERSION = 52
LUA_VERSION = 5.2
MAKEINFO = ${SHELL} /home/rrt/repo/luaposix/build-aux/missing --run makeinfo
MANIFEST_TOOL = :
MKDIR_P = /bin/mkdir -p
NM = /usr/bin/nm -B
NMEDIT = 
...
PACKAGE_STRING = luaposix 5.1.24
...
WARN_CFLAGS = 
WERROR_CFLAGS = 
abs_builddir = /home/rrt/repo/luaposix
abs_srcdir = /home/rrt/repo/luaposix
abs_top_builddir = /home/rrt/repo/luaposix
abs_top_srcdir = /home/rrt/repo/luaposix
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
builddir = .
datadir = /home/rrt/local/share/lua/5.2
...
gltests_LIBOBJS = 
gltests_LTLIBOBJS = 
gltests_WITNESS = IN_LUAPOSIX_GNULIB_TESTS
...
install_sh = ${SHELL} /home/rrt/repo/luaposix/build-aux/install-sh
libdir = /home/rrt/local/lib/x86_64-linux-gnu/lua/5.2
...
pdfdir = ${docdir}
pkgluadir = ${luadir}/luaposix
pkgluaexecdir = ${luaexecdir}/luaposix
...
luaposix.rockspec: $(top_builddir)/config.status $(srcdir)/luaposix.rockspec.in
...
curses_c.la: $(curses_c_la_OBJECTS) $(curses_c_la_DEPENDENCIES) $(EXTRA_curses_c_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(curses_c_la_LINK)  $(curses_c_la_OBJECTS) $(curses_c_la_LIBADD) $(LIBS)
posix_c.la: $(posix_c_la_OBJECTS) $(posix_c_la_DEPENDENCIES) $(EXTRA_posix_c_la_DEPENDENCIES) 
	$(AM_V_CCLD)$(posix_c_la_LINK) -rpath $(libdir) $(posix_c_la_OBJECTS) $(posix_c_la_LIBADD) $(LIBS)
...
include ./$(DEPDIR)/lcurses.Plo
include ./$(DEPDIR)/posix_c_la-lposix.Plo
...
posix_c_la-lposix.lo: lposix.c
	$(AM_V_CC)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(posix_c_la_CFLAGS) $(CFLAGS) -MT posix_c_la-lposix.lo -MD -MP -MF $(DEPDIR)/posix_c_la-lposix.Tpo -c -o posix_c_la-lposix.lo `test -f 'lposix.c' || echo '$(srcdir)/'`lposix.c
	$(AM_V_at)$(am__mv) $(DEPDIR)/posix_c_la-lposix.Tpo $(DEPDIR)/posix_c_la-lposix.Plo
#	$(AM_V_CC)source='lposix.c' object='posix_c_la-lposix.lo' libtool=yes \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(AM_V_CC_no)$(LIBTOOL) $(AM_V_lt) --tag=CC $(AM_LIBTOOLFLAGS) $(LIBTOOLFLAGS) --mode=compile $(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(AM_CPPFLAGS) $(CPPFLAGS) $(posix_c_la_CFLAGS) $(CFLAGS) -c -o posix_c_la-lposix.lo `test -f 'lposix.c' || echo '$(srcdir)/'`lposix.c
...
installdirs:
	for dir in "$(DESTDIR)$(libdir)" "$(DESTDIR)$(datadir)" "$(DESTDIR)$(docdir)" "$(DESTDIR)$(examplesdir)"; do \
...
.PHONY: CTAGS GTAGS all all-am am--refresh check check-am check-local \
	...
	install-dist_dataDATA install-dist_docDATA install-dvi \
	...
	uninstall-dist_docDATA uninstall-examplesDATA \
	uninstall-libLTLIBRARIES
